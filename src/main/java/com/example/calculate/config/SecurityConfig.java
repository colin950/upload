...
import com.example.calculate.exception.AccessDeniedExceptionHandler;
import com.example.calculate.exception.ErrorResponse;
import com.example.calculate.exception.code.ErrorCode;
import com.example.calculate.exception.code.ErrorTitle;
import com.example.calculate.security.UserAuthenticationProvider;
import com.example.calculate.security.UserSecurityContextRepository;
import com.example.calculate.utils.MapperUtils;
...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers(
                ...
                new AntPathRequestMatcher("/v1/calculate/**"));
    }

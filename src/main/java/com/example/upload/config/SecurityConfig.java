...
import com.example.upload.exception.AccessDeniedExceptionHandler;
import com.example.upload.exception.ErrorResponse;
import com.example.upload.exception.code.ErrorCode;
import com.example.upload.exception.code.ErrorTitle;
import com.example.upload.security.UserAuthenticationProvider;
import com.example.upload.security.UserSecurityContextRepository;
...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers(
                ...
                new AntPathRequestMatcher("/v1/file/**"));
    }
